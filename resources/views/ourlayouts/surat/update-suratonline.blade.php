    ...
    <x-auth-card>
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('letters.update', $letter->id) }}">
            ...
            <div class="mt-4">
                ...
                <textarea id="message" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="message" :value="old('message')" required>{{ $letter->message }}</textarea>
