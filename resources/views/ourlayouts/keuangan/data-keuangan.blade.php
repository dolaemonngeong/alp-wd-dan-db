...
<div class="flex items-center w-100% container-fluid">
    ...
    <a class="btn text-light ms-auto" href="{{ route("finances.create")}}" role="button" style="background-color: #124A49">Tambah Data</a>
</div>
<div class="container-fluid my-4">
    <form action="/data-keuangan" method="GET" value="{{ $search }}" class="form d-md-flex" role="search">
        <input type="search" name="search" class="form-control outline-secondary rounded-md me-3" placeholder="Cari berdasarkan deskripsi, total, harga...">
        <select name="sort" id="sort" class="btn btn-outline-secondary dropdown-toggle mx-4" type="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<p class="fw-bold">Total hingga saat ini = Rp {{ $totkeuangan }}</p>
@endsection
